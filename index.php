            ...
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-md-5">
                    <div class="about_text">
                        ...
                        <h2>We care your pet
                            As you care</h2>
                        <p>Working in conjunction with humanitarian aid agencies, we have supported programmes to help alleviate animals in need of furever homes.</p>
                        <a href="contact.html" class="btn_1">Contact Us</a>
                    </div>
                </div>
            </div>
            ...
            <div class="row">
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        ...
                        <h3><a href="paymentform.php">Donations</a></h3>
                        <p><b>Help to serve our cause</b></p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        <img src="img/single_service_3.png" alt="#">
                        <h3><a href="adopt.php">Pet Adoption</a></h3>
                        <p><b>Adopt Don't Shop</b></p>
                    </div>
                </div>
                <div class="col-lg-4 col-sm-6">
                    <div class="single_service_part">
                        ...
                        <p><b>Get answers to all your questions</b></p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-5 col-md-6">
                    <div class="counter_text">
                        <h2>We need your help
                                Adopt Us</h2>
                        <p>“Saving one animal will not change the world, but surely for that one animal, the world will change forever.”</p>
                        ...
                        <a href="#" class="btn_1">Check us Out</a>
                    </div>
                </div>
