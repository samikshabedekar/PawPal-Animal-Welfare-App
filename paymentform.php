...
<div class="container">
                ...
                <div class="modal-body">    
                        <form action="Paytm_Web_Sample_Kit_PHP-master/PaytmKit/TxnTest.php" method="post" class="register-wthree" enctype='multipart/form-data'>
                        ...
                        <input type="number" class="form-control" placeholder="Amount Should be less than 1 Lakh" name="amt" id="amt" required="">
                            ...
                            <div class="right-w3l">
                                 ...
                                 <input type="submit" class="form-control button" type="submit" name="send" value="Send" >
                            </div><br><br>
